<?php 
class PtsWidgetproduct_list_2 extends PtsWidgetPageBuilder {

		public $name = 'product_list_2';
		public $group = 'product';
		public $usemeneu = false;
		
		public static function getWidgetInfo(){
			return array('label' =>  ('Product List 2'), 'explain' => 'Product List With Option: Special, Latest, Popular, Bestseller,  Featured, Top Rating', 'group' => 'opencart'  );
		}
