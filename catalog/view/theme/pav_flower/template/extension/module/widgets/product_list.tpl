...
<div class="bg-carousel panel-default productcarousel space-10">
	...
	<div class="widget-heading panel-heading block-border"><img class="product" alt="logo footer" src="image/catalog/our_product.png"></div>
	<!-- <div class="image-item effect-adv hidden-xs hidden-sm">
		<img class="img-responsive product" alt=" " src="image/catalog/our_product.png"/>						
	 </div> -->
	<?php } ?>
				...
				<?php $pages = array_chunk( $products, $itemsperpage); ?>
					...
					<div class="item <?php if($k==0) {?>active<?php } ?> products-block">
						<?php foreach( $tproducts as $i => $product ) {  $i=$i+1;?>
							...
							?>	
								<div class="col-sm-6 col-xs-12 col-lg-<?php echo $span;?> col-md-<?php echo $span;?> <?php if($i%$cols == 0) { echo "last";} ?> product-col">
