...
<div class="<?php echo $prefix; ?> newsletter" id="newsletter_<?php echo $position.$module;?>">
	<form id="formNewLestter" method="post" action="<?php echo $action; ?>" class="formNewLestter">
		<div class="box-heading">
		    <h3><?php echo $objlang->get("text_newsletter");?></h3>          
		</div>              

     	<div class="description space-30 space-padding-t5 hidden "><?php echo html_entity_decode( $description );?></div> 
